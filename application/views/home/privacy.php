<div class="policy-dis-page container" id="policy">
            					...
            					<p>Moreover, the personal information of the visitors can also be used for keeping you updated with the latest offers, promotional emails, RSS feeds, and other key information that can benefit you. We use the data only on users’ consent to “SUBSCRIBE” it and we can also unsubscribe it on the users’ request. </p>
            					...
            					<p>Statement AppsChopper.com has all the rights to amend or update the privacy policy without notifying you. Therefore, we recommend all our customers to review our privacy statements regularly to remain updated with the modified policies. By accessing our website, you are supposed to abide by the policies of AppsChopper that are stated in this privacy statements. </p>
            					...
            					<h4>Contact Us</h4> 
            					<p>If any information that is shared by you is incorrect or incomplete, then please inform us by sending an email. You are free to clear all your doubts related to our privacy policy by reaching us at <a href="mailto:sales@appschopper.com"> sales@appschopper.com</a></p>				
            				</div>